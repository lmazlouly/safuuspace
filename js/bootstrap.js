...
function myFunction(x) {
    if (x.matches) { // If media query matches
        $.fn.bootstrap_coustomize_nav = function(){
		    // body...
		    $('nav.navbar  .navbar-collapse').find('ul.children').parent().addClass('has_item');
		    $(".navigation .collapse .has_item > a").click(function(){
		      $(this).siblings(".children").slideToggle('height', function() {
		        $(this).parent().toggleClass('selected-item', $(this).is(':visible'));
		      });
		       return false;
		    });
		}
	    // It's a match
	    $('.nav.navbar').bootstrap_coustomize_nav();
    }
}
